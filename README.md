...
- ~~**Redis 5** — XAUTOCLAIM not supported, crash recovery disabled.~~ **Resolved 2026-09-18** — upgraded to Redis 6.2.20 (see [docs/redis_upgrade_guide.md](docs/redis_upgrade_guide.md)); confirmed via worker logs, no more `XAUTOCLAIM failed` warnings, `crash_recovery=enabled`.
